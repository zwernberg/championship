<template>
  <div id="app">
    ...
    <ul>
      <li v-for='(player, index) in nealPlayers' :key='index'>
    ...
    <ul>
      <li v-for='(player, index) in kenseyPlayers' :key='index'>
        <b>Name</b>: {{player.player.firstName}}  {{player.player.lastName}}
        <b>Position</b>: {{getPosition(player)}}
        <b>Projected</b>: {{player.currentPeriodProjectedStats.appliedStatTotal}}
      </li>
...
var roster_slots = {0:'QB',1: 'QB', 2:'RB',3:'WR', 4:'WR',6:'TE',23:'FLEX',16:'D/ST',17:'K',20:'Bench'};
